...
/*Use RENESAS's GLCDC on DA8 platforms */
#define LV_USE_DRAW_DA8 0
...
/*1: Enable the system monitor component*/
#define LV_USE_SYSMON 0

/*1: Enable the file system interfaces*/
...
/*1: Enable the built-in (v)snprintf */
#define LV_USE_BUILTIN_SNPRINTF 0
#if LV_USE_BUILTIN_SNPRINTF == 0
    #define LV_SNPRINTF_USE_FLOAT 0
#endif
...
/*1: Enable the file explorer (requires lv_snapshot for thumbnails)*/
