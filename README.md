...
在资源受限的 ESP32 平台上，将 **Light and Versatile Graphics Library（LVGL）** 与 SPI 小屏、称重与网络功能结合，完成一套可运行的交互界面。笔记以 **LVGL 的集成方法、显示管线与内存权衡** 为主线，辅以项目结构与构建说明，供课程设计或毕业设计阶段回顾与复现。
